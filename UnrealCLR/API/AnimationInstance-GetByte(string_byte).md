...
## AnimationInstance.GetByte(string, byte) Method
Retrieves the value of the byte property  
```csharp
public bool GetByte(string name, ref byte value);
```
#### Parameters
<a name='UnrealEngine-Framework-AnimationInstance-GetByte(string_byte)-name'></a>
`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
  
<a name='UnrealEngine-Framework-AnimationInstance-GetByte(string_byte)-value'></a>
