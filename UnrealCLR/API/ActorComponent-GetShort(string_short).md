...
## ActorComponent.GetShort(string, short) Method
Retrieves the value of the short property  
```csharp
public bool GetShort(string name, ref short value);
```
#### Parameters
<a name='UnrealEngine-Framework-ActorComponent-GetShort(string_short)-name'></a>
`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
  
<a name='UnrealEngine-Framework-ActorComponent-GetShort(string_short)-value'></a>
