...
## AnimationInstance.GetUInt(string, uint) Method
Retrieves the value of the unsigned integer property  
```csharp
public bool GetUInt(string name, ref uint value);
```
#### Parameters
<a name='UnrealEngine-Framework-AnimationInstance-GetUInt(string_uint)-name'></a>
`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
  
<a name='UnrealEngine-Framework-AnimationInstance-GetUInt(string_uint)-value'></a>
