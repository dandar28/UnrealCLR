...
## ActorComponent.SetUInt(string, uint) Method
Sets the value of the unsigned integer property  
```csharp
public bool SetUInt(string name, uint value);
```
#### Parameters
<a name='UnrealEngine-Framework-ActorComponent-SetUInt(string_uint)-name'></a>
`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
  
<a name='UnrealEngine-Framework-ActorComponent-SetUInt(string_uint)-value'></a>
