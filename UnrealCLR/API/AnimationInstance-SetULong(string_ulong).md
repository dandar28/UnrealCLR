...
## AnimationInstance.SetULong(string, ulong) Method
Sets the value of the unsigned long property  
```csharp
public bool SetULong(string name, ulong value);
```
#### Parameters
<a name='UnrealEngine-Framework-AnimationInstance-SetULong(string_ulong)-name'></a>
`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
  
<a name='UnrealEngine-Framework-AnimationInstance-SetULong(string_ulong)-value'></a>
