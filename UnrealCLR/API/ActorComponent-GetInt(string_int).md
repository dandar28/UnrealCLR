...
## ActorComponent.GetInt(string, int) Method
Retrieves the value of the integer property  
```csharp
public bool GetInt(string name, ref int value);
```
#### Parameters
<a name='UnrealEngine-Framework-ActorComponent-GetInt(string_int)-name'></a>
`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
  
<a name='UnrealEngine-Framework-ActorComponent-GetInt(string_int)-value'></a>
